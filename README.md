...
- `.agents/skills/sentinelpipe-redteam/SKILL.md`
...
- `benchmarks/2026-03-11_ollama_head_to_head_gemma4b/REPORT.md`
- `benchmarks/2026-03-11_ollama_head_to_head_gemma4b/PUBLIC_SUMMARY.json`
...
- `USER_GUIDE.md`
- `SECURITY.md`
- `gazetentwhitepaper_research_paper_revised.md`
- `AGENTIC_REDTEAM_ARCHITECTURE.md`
